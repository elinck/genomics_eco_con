...
![*Total resources are defined by cores used x memory needed x runtime*](images/cores.png)
...
seqtk size ~/bioe-591-genomics/course-materials/data/catamenia_analis.fastq.gz >> size.txt
...
Though Globus is convenient and powerful, you may find yourself wanting to use `Git` and GitHub directly from the cluster. Doing so requires a different approach than configuring your own laptop due to 
