...
Snakemake has [extensive documentation](https://snakemake.readthedocs.io/en/stable/). I do not begin to presume you will read much of it, but as usual, it is worth getting oriented to over the course of 5-10 minutes. You may then creat a config file (`snakemake.yaml`) to program via `Mamba`: 
